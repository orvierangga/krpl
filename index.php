            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
			   ...
			   <!--echo' <td><img src="img/'.$data[4].'" width="60" /></td>';-->
                <img class="d-block img-fluid" src=<?php echo' "img/'.$data[4].'" '; ?> alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="img/krpl/900x350" alt="Second slide">
              </div>
              <div class="carousel-item">
